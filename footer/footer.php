...
<head>
      ...
      <link href="../footer/css/font-awesome.min.css" rel="stylesheet">
      <link href="../footer/css/main.css" rel="stylesheet">
...
<style>
        ...
        <div class="container">
            <div class="row"> <br>
                <div class="col-md-4 col-sm-6">
                    <h4 class="noMargin">Thought Leadership</h4>
                    <div class="row">
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2016 <a target="_blank" href="http://www.miraclesoft.com" title="Copyright">Miracle Software Systems, Inc.</a>
                </div>
                <div class="col-sm-6">
